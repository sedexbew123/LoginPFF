...
{
    public partial class CapturaFoto : Form, ICapturaFotoView
    {
        ...
        {
            this.Text = "Tomar foto del empleado";
        ...
        {
            // Defensa final: si por cualquier motivo llega un Bitmap inválido
            // o el formulario ya está cerrándose, no debe tumbar la aplicación.
        ...
        public void MostrarFotoCapturada(Bitmap foto)
        {
            ...
            {
                // No se pudo clonar/mostrar; se ignora silenciosamente.
            }
        }
