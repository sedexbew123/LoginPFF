...
{
    public partial class RecuperarUsuario : Form, Interfaces.IRecuperarUsuarioView
    {
        private Presenter.RecuperarUsuarioPresenter _presenter;
        #region
        ...
        public RecuperarUsuario()
        {
            InitializeComponent();
            AsociarEventos();
            _presenter = new Presenter.RecuperarUsuarioPresenter(this);
        }
        ...
        private void RecuperarUsuario_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public void MostrarEstado(string mensaje, TipoMensaje tipo)
        {
            ...
            lblEstado.Visible = !string.IsNullOrWhiteSpace(mensaje);
            if (!lblEstado.Visible) return;
            lblEstado.ForeColor = tipo == TipoMensaje.Exito ? Color.Green
                                : tipo == TipoMensaje.Error ? Color.Red
                                : Color.Black;
        }
